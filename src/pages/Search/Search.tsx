...
import FixedHeader, { FixedHeaderTitle } from "../../components/FixedHeader/FixedHeader";
...
const Search: React.FC = () => {
  ...
  return (
    <>
        ...
        <SearchRadios>
          <SearchRadio>
            <input
              ...
              checked={currentRadioValue === "movie"}
            />
      ...
      {data.length > 1 && (
        <MediaContainer items={data} loading={loading} setPage={setPage} hasMore={hasMore} mediaType={currentRadioValue} />
      )}
    </>
  );
};
